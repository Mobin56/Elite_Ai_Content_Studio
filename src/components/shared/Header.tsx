...
export default function Header() {
  const { theme, toggleTheme, aiCredits, activeView } = useAppStore();
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2.5 pl-2 border-l border-[var(--glass-border)]">
          ...
          <div className="hidden md:block text-left">
            <p className="text-xs font-bold leading-tight">Principal Admin</p>
            <p className="text-[10px] text-muted-foreground">admin@eliteschool.edu</p>
          </div>
        </div>
      </div>
    </header>
